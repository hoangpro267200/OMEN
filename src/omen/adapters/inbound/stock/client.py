...
class VNStockClient:
    ...
    def get_quote(self, item: StockWatchlistItem) -> StockQuote | None:
        ...
        try:
            ...
            quote_data = stock.quote.history(start="2024-01-01", end=datetime.now().strftime("%Y-%m-%d"))
...
class MockStockClient:
    ...
    def get_quote(self, item: StockWatchlistItem) -> StockQuote:
        ...
        base_prices = {
            "SPX": 5200.0, "NDX": 18500.0, "DJI": 39000.0, "VIX": 15.0,
            "DXY": 104.0, "EURUSD": 1.08, "USDJPY": 150.0, "USDVND": 24500.0,
            "US10Y": 4.5, "US2Y": 5.0,
            "GOLD": 2050.0, "SILVER": 23.0, "CRUDE": 78.0, "BRENT": 82.0,
            "VNINDEX": 1250.0, "VN30": 1300.0, "HNX": 230.0,
            "VNM": 75000.0, "VIC": 42000.0, "VCB": 95000.0, "FPT": 125000.0,
        }
